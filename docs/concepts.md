...
**Sinks** are output destinations where ARM compiles and places files. Each sink specifies a target directory and compilation format for a specific AI tool (Cursor, Amazon Q, GitHub Copilot, Kiro CLI).
