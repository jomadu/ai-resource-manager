	...
	mockReg := &mockRegistry{
		versions: map[string][]core.PackageMetadata{
			"ruleset1": {
				...
				{Name: "ruleset1", Version: core.Version{Major: 2, Minor: 0, Patch: 0, Version: "2.0.0"}},
			},
			"promptset1": {
				{Name: "promptset1", Version: core.Version{Major: 1, Minor: 0, Patch: 0, Version: "1.0.0"}},
				{Name: "promptset1", Version: core.Version{Major: 3, Minor: 0, Patch: 0, Version: "3.0.0"}},
			},
		},
		packages: map[string]*core.Package{
			"ruleset1@2.0.0": {
				Metadata:  core.PackageMetadata{Name: "ruleset1", Version: core.Version{Major: 2, Minor: 0, Patch: 0, Version: "2.0.0"}},
				Files:     []*core.File{{Path: "rule.yml", Content: []byte("test")}},
				Integrity: "hash1-new",
			},
			"promptset1@3.0.0": {
				Metadata:  core.PackageMetadata{Name: "promptset1", Version: core.Version{Major: 3, Minor: 0, Patch: 0, Version: "3.0.0"}},
