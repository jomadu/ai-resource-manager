	...
	mockReg := &mockRegistry{
		versions: map[string][]core.PackageMetadata{
			"ruleset1": {
				...
				{Name: "ruleset1", Version: core.Version{Major: 1, Minor: 2, Patch: 0, Version: "1.2.0"}},
			},
			"promptset1": {
				{Name: "promptset1", Version: core.Version{Major: 2, Minor: 0, Patch: 0, Version: "2.0.0"}},
				{Name: "promptset1", Version: core.Version{Major: 2, Minor: 1, Patch: 0, Version: "2.1.0"}},
			},
		},
		packages: map[string]*core.Package{
			"ruleset1@1.2.0": {
				Metadata:  core.PackageMetadata{Name: "ruleset1", Version: core.Version{Major: 1, Minor: 2, Patch: 0, Version: "1.2.0"}},
				Files:     []*core.File{{Path: "rule.yml", Content: []byte("test")}},
				Integrity: "hash1-new",
			},
			"promptset1@2.1.0": {
				Metadata:  core.PackageMetadata{Name: "promptset1", Version: core.Version{Major: 2, Minor: 1, Patch: 0, Version: "2.1.0"}},
...
func TestUpdateAll_MixedTypes(t *testing.T) {
	...
	mockReg := &mockRegistry{
		versions: map[string][]core.PackageMetadata{
			"ruleset1": {
				{Name: "ruleset1", Version: core.Version{Major: 1, Minor: 0, Patch: 0, Version: "1.0.0"}},
				{Name: "ruleset1", Version: core.Version{Major: 1, Minor: 1, Patch: 0, Version: "1.1.0"}},
			},
			"promptset1": {
				{Name: "promptset1", Version: core.Version{Major: 2, Minor: 0, Patch: 0, Version: "2.0.0"}},
			},
		...
		packages: map[string]*core.Package{
			"ruleset1@1.1.0": {
				Metadata:  core.PackageMetadata{Name: "ruleset1", Version: core.Version{Major: 1, Minor: 1, Patch: 0, Version: "1.1.0"}},
				Files:     []*core.File{{Path: "rule.yml", Content: []byte("test")}},
				Integrity: "hash1-new",
			},
		},
...
func TestUpdateAll_ManyDependencies(t *testing.T) {
	...
	for i := 0; i < 50; i++ {
		...
		versions[pkgName] = []core.PackageMetadata{
			{Name: pkgName, Version: core.Version{Major: 1, Minor: 0, Patch: 0, Version: "1.0.0"}},
			{Name: pkgName, Version: core.Version{Major: 1, Minor: 1, Patch: 0, Version: "1.1.0"}},
		}

		packages[pkgName+"@1.1.0"] = &core.Package{
			Metadata:  core.PackageMetadata{Name: pkgName, Version: core.Version{Major: 1, Minor: 1, Patch: 0, Version: "1.1.0"}},
			Files:     []*core.File{{Path: "rule.yml", Content: []byte("test")}},
			Integrity: "hash-new",
		}
	}
