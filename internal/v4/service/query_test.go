	...
	t.Run("list outdated dependencies", func(t *testing.T) {
		...
		pkg1 := &core.Package{
			Metadata: core.PackageMetadata{
				...
				Version:      core.Version{Major: 1, Minor: 0, Patch: 0, Version: "1.0.0"},
			},
		}
		pkg2 := &core.Package{
			Metadata: core.PackageMetadata{
				Name:         "ruleset1",
				RegistryName: "test-reg",
				Version:      core.Version{Major: 1, Minor: 5, Patch: 0, Version: "1.5.0"},
			},
		}
		pkg3 := &core.Package{
			Metadata: core.PackageMetadata{
				Name:         "ruleset1",
				RegistryName: "test-reg",
				Version:      core.Version{Major: 2, Minor: 0, Patch: 0, Version: "2.0.0"},
			},
		}
