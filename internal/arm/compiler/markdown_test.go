...
func TestMarkdownRuleGenerator_GenerateRule_NotFound(t *testing.T) {
	generator := &MarkdownRuleGenerator{}
	ruleset := &resource.RulesetResource{
		Spec: resource.RulesetSpec{
			Rules: map[string]resource.Rule{},
...
func TestMarkdownPromptGenerator_GeneratePrompt(t *testing.T) {
	generator := &MarkdownPromptGenerator{}
...
func TestMarkdownPromptGenerator_GeneratePrompt_NotFound(t *testing.T) {
	generator := &MarkdownPromptGenerator{}
	promptset := &resource.PromptsetResource{
		Spec: resource.PromptsetSpec{
			Prompts: map[string]resource.Prompt{},
...
func TestMarkdownRuleFilenameGenerator_GenerateRuleFilename(t *testing.T) {
	generator := &MarkdownRuleFilenameGenerator{}
...
func TestMarkdownRuleFilenameGenerator_GenerateRuleFilename_EmptyInputs(t *testing.T) {
	generator := &MarkdownRuleFilenameGenerator{}
...
func TestMarkdownPromptFilenameGenerator_GeneratePromptFilename(t *testing.T) {
	generator := &MarkdownPromptFilenameGenerator{}
...
func TestMarkdownPromptFilenameGenerator_GeneratePromptFilename_EmptyInputs(t *testing.T) {
	generator := &MarkdownPromptFilenameGenerator{}
